      ...
      {!analysis && !analyzing && (
        <div className="px-4 py-3 bg-gray-700">
          ...
          >
            ...
            Analyze with AI (Gemini 2.0 Flash)
          </button>
          {analyzeError && (
        ...
        {analysis?.transcriptSegment && (
          <div className="border-t border-gray-700 pt-4">
            ...
            <div className="bg-gray-800 rounded-lg p-3">
              {typeof analysis.transcriptSegment !== 'string' && (
                <div className="text-xs text-gray-500 mb-2">
                  {formatDuration(analysis.transcriptSegment.start)} - {formatDuration(analysis.transcriptSegment.end)}
                </div>
              )}
              <p className="text-sm text-gray-300 italic leading-relaxed">
                &ldquo;{typeof analysis.transcriptSegment === 'string'
                  ? analysis.transcriptSegment
                  : analysis.transcriptSegment.text}&rdquo;
              </p>
            </div>
