  ...
  return (
    <div className="fixed inset-0 bg-gray-900 overflow-y-scroll" style={{ WebkitOverflowScrolling: 'touch' }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 pb-24">
        ...
        {/* Export Button - Always visible when processed (even without synthesis) */}
        {processingResult && !processingResult.synthesis && (
          <section className="mb-6">
            <button
              ...
              className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-800 disabled:opacity-50 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
            >
              {isExporting ? (
                <>
                  <svg className="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24">
        ...
        {processingResult?.synthesis && processingResult.synthesis.deliverables.length > 0 && (
          <section className="mb-8">
            ...
            <button
              ...
              disabled={isExporting}
              className="w-full mb-4 py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-800 disabled:opacity-50 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
            >
              {isExporting ? (
                <>
                  <svg className="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24">
